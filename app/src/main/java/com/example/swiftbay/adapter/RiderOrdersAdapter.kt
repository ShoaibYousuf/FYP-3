...
class RiderOrdersAdapter(
    private var context: Context,
    var callBack: GeneralCallBack,
    var results: ArrayList<OrderData>
) : RecyclerView.Adapter<RiderOrdersAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = inflater.inflate(R.layout.orders_rider_item, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.update.setOnClickListener { v: View? ->
